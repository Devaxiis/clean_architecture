import 'package:clean_architecture/feature/daily_news/presentation/bloc/articel/local/local_article_bloc.dart';
...
class SavedArticles extends HookWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<LocalArticleBloc>()..add(const GetSaveArticles()),
      child: Scaffold(
        appBar: _buildAppBar(),
        body: _buildBody(),
      ),
